...
RSA의 우물이에요. 타원곡선 공방보다 오래전부터 있던, 돌을 쌓아 만든 우물이죠. 페디버스의 옛 방식(draft-cavage의 HTTP 서명)은 지금도 이 우물의 물을 써요. 그래서 fedify는 RSA 키와 Ed25519 키를 둘 다 지니고 다녀요 — 새 마을과 옛 마을, 양쪽과 이야기하려고요.

원리는 한 줄로 말할 수 있어요. 큰 소수를 둘 골라 곱하는 건 한순간이에요. 그 곱만 보고 원래 둘로 되돌려 나누는 건, 자릿수가 충분히 크면 천 년이 걸려요. 곱셈은 비탈을 내려가는 일, 소인수분해는 오르는 일. 우물은, 떨어지기는 쉽고 오르기는 어려워요.
